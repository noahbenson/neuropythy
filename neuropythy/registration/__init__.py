...
_register_retinotopy_help = \
    ...
    * surf/lh.predicted_polar_angle.mgz  surf/rh.predicted_polar_angle.mgz
      surf/lh.predicted_eccentricity.mgz surf/rh.predicted_eccentricity.mgz
      surf/lh.predicted_V123_ROI.mgz     surf/rh.predicted_V123_ROI.mgz
    ...
    * mri/predicted_polar_angle.mgz
      mri/predicted_eccentricity.mgz
      mri/predicted_V123_ROI.mgz
      ...
      original anatomical scan, use mri_convert:
       > mri_convert -rl mri/rawavg.mgz mri/predicted_polar_angle.mgz \
                     mri/scanner.predicted_polar_angle.mgz
    ...
    * --eccen-tag=|-y<tag>
      ...
      'predicted_eccenticity', 'predicted_polar_angle', and 'predicted_V123_ROI'.
    ...
    * --no-volume-export|-x
      ...
      the registration export refers to the <hemi>.retinotopy.sphere.reg file, 
      ...
      <hemi>.predicted_eccentricity.mgz and similar files that are written to the
