...
def auto_download(status,
    ...
    status = (['structure','retinotopy'] if status is True        else
              []                         if bool(status) is False else
              [status.lower()]           if pimms.is_str(status)  else
...
hcp_filemap_instructions = [
    'T1w', [
        ...
        'Native', [
            '{id}.L.white.native.surf.gii', (
                {'surface':'white', 'hemi':'lh_native_MSMSulc', 'load':_load_surfx},
                {'surface':'white', 'hemi':'lh_native_MSMSulc'},
                {'surface':'white', 'hemi':'lh_native_MSMAll', 'load':_load_surfx}),
            '{id}.L.midthickness.native.surf.gii', (
                {'surface':'midgray', 'hemi':'lh_native_MSMSulc', 'load':_load_surfx},
                {'surface':'midgray', 'hemi':'lh_native_MSMAll', 'load':_load_surfx}),
            '{id}.L.pial.native.surf.gii', (
                {'surface':'pial', 'hemi':'lh_native_MSMSulc', 'load':_load_surfx},
                {'surface':'pial', 'hemi':'lh_native_MSMAll', 'load':_load_surfx}),
            '{id}.L.inflated.native.surf.gii', (
                {'surface':'inflated', 'hemi':'lh_native_MSMSulc', 'load':_load_surfx},
                {'surface':'inflated', 'hemi':'lh_native_MSMAll', 'load':_load_surfx}),
            '{id}.L.very_inflated.native.surf.gii', (
                {'surface':'very_inflated', 'hemi':'lh_native_MSMSulc', 'load':_load_surfx},
                {'surface':'very_inflated', 'hemi':'lh_native_MSMAll', 'load':_load_surfx}),
            '{id}.R.white.native.surf.gii', (
                {'surface':'white', 'hemi':'rh_native_MSMSulc', 'load':_load_surfx},
                {'surface':'white', 'hemi':'rh_native_MSMAll', 'load':_load_surfx}),
            '{id}.R.midthickness.native.surf.gii', (
                {'surface':'midgray', 'hemi':'rh_native_MSMSulc', 'load':_load_surfx},
                {'surface':'midgray', 'hemi':'rh_native_MSMAll', 'load':_load_surfx}),
            '{id}.R.pial.native.surf.gii', (
                {'surface':'pial', 'hemi':'rh_native_MSMSulc', 'load':_load_surfx},
                {'surface':'pial', 'hemi':'rh_native_MSMAll', 'load':_load_surfx}),
            '{id}.R.inflated.native.surf.gii', (
                {'surface':'inflated', 'hemi':'rh_native_MSMSulc', 'load':_load_surfx},
                {'surface':'inflated', 'hemi':'rh_native_MSMAll', 'load':_load_surfx}),
            '{id}.R.very_inflated.native.surf.gii', (
                {'surface':'very_inflated', 'hemi':'rh_native_MSMSulc', 'load':_load_surfx},
                {'surface':'very_inflated', 'hemi':'rh_native_MSMAll', 'load':_load_surfx})],
        'fsaverage_LR32k', [
    ...
    'MNINonLinear', [
        ...
        '{id}.L.ArealDistortion_FS.164k_fs_LR.shape.gii',      {'property':'areal_distortion_FS',
                                                                'hemi':'lh_LR164k_MSMSulc'},
        '{id}.L.ArealDistortion_MSMSulc.164k_fs_LR.shape.gii', {'property':'areal_distortion',
                                                                'hemi':'lh_LR164k_MSMSulc'},
        '{id}.L.MyelinMap.164k_fs_LR.func.gii',                {'property':'myelin',
                                                                'hemi':'lh_LR164k_MSMSulc'},
        '{id}.L.MyelinMap_BC.164k_fs_LR.func.gii',             {'property':'myelin_bc',
                                                                'hemi':'lh_LR164k_MSMSulc'},
        '{id}.L.SmoothedMyelinMap.164k_fs_LR.func.gii',        {'property':'myelin_smooth',
                                                                'hemi':'lh_LR164k_MSMSulc'},
        '{id}.L.SmoothedMyelinMap_BC.164k_fs_LR.func.gii',     {'property':'myelin_smooth_bc',
                                                                'hemi':'lh_LR164k_MSMSulc'},
        '{id}.L.RefMyelinMap.164k_fs_LR.func.gii',             {'property':'myelin_ref',
                                                                'hemi':'lh_LR164k_MSMSulc'},
        '{id}.L.BA.164k_fs_LR.label.gii',                      ({'property':'brodmann_area',
                                                                 'hemi':'lh_LR164k_MSMSulc'},
                                                                {'property':'brodmann_area',
                                                                 'hemi':'lh_LR164k_MSMAll'}),
        '{id}.L.aparc.164k_fs_LR.label.gii',         ({'property':'Desikan06_parcellation',
                                                       'hemi':'lh_LR164k_MSMSulc'},
                                                      {'property':'Desikan06_parcellation',
                                                       'hemi':'lh_LR164k_MSMAll'}),
        '{id}.L.aparc.a2009s.164k_fs_LR.label.gii',  ({'property':'parcellation',
                                                       'hemi':'lh_LR164k_MSMSulc'},
                                                      {'property':'parcellation',
                                                       'hemi':'lh_LR164k_MSMAll'},
                                                      {'property':'Destrieaux09_parcellation',
                                                       'hemi':'lh_LR164k_MSMSulc'},
                                                      {'property':'Destrieaux09_parcellation',
                                                       'hemi':'lh_LR164k_MSMAll'}),
        '{id}.L.atlasroi.164k_fs_LR.shape.gii',      ({'property':'atlas',
                                                       'hemi':'lh_LR164k_MSMSulc',
                                                       'load':_load_fsLR_atlasroi,
                                                       'filt':lambda x:x[0].astype(np.bool)},
                                                      {'property':'atlas',
                                                       ...
                                                       'load':_load_fsLR_atlasroi,
                                                       'filt':lambda x:x[0].astype(np.bool)}),
        '{id}.L.curvature.164k_fs_LR.shape.gii',     {'property':'curvature',
                                                      'hemi':'lh_LR164k_MSMSulc',
                                                      'filt':lambda c: -c},
        '{id}.L.sulc.164k_fs_LR.shape.gii',          {'property':'convexity',
                                                      'hemi':'lh_LR164k_MSMSulc'},
        '{id}.L.corrThickness.164k_fs_LR.shape.gii', {'property':'thickness',
                                                      'hemi':'lh_LR164k_MSMSulc'},
        '{id}.L.thickness.164k_fs_LR.shape.gii',     {'property':'thickness_uncorrected',
                                                      'hemi':'lh_LR164k_MSMSulc'},
        '{id}.L.white.164k_fs_LR.surf.gii',         {'surface':'white',
                                                     'hemi':'lh_LR164k_MSMSulc',
                                                     'load':_load_surfx},
        '{id}.L.midthickness.164k_fs_LR.surf.gii',  {'surface':'midgray',
                                                     'hemi':'lh_LR164k_MSMSulc',
                                                     'load':_load_surfx},
        '{id}.L.pial.164k_fs_LR.surf.gii',          {'surface':'pial',
                                                     'hemi':'lh_LR164k_MSMSulc',
                                                     'load':_load_surfx},
        '{id}.L.inflated.164k_fs_LR.surf.gii',      {'surface':'inflated',
                                                     'hemi':'lh_LR164k_MSMSulc',
                                                     'load':_load_surfx},
        '{id}.L.very_inflated.164k_fs_LR.surf.gii', {'surface':'very_inflated',
                                                     'hemi':'lh_LR164k_MSMSulc',
                                                     'load':_load_surfx},
        '{id}.L.white_MSMAll.164k_fs_LR.surf.gii',  {'surface':'white',
                                                     'hemi':'lh_LR164k_MSMAll',
                                                     'load':_load_surfx},
        '{id}.L.midthickness_MSMAll.164k_fs_LR.surf.gii',  {'surface':'midgray',
                                                            'hemi':'lh_LR164k_MSMAll',
                                                            'load':_load_surfx},
        '{id}.L.pial_MSMAll.164k_fs_LR.surf.gii',          {'surface':'pial',
                                                            'hemi':'lh_LR164k_MSMAll',
                                                            'load':_load_surfx},
        '{id}.L.inflated_MSMAll.164k_fs_LR.surf.gii',      {'surface':'inflated',
                                                            'hemi':'lh_LR164k_MSMAll',
                                                            'load':_load_surfx},
        '{id}.L.very_inflated_MSMAll.164k_fs_LR.surf.gii', {'surface':'very_inflated',
                                                            'hemi':'lh_LR164k_MSMAll',
                                                            'load':_load_surfx},
        '{id}.L.sphere.164k_fs_LR.surf.gii',               ({'registration':'fs_LR',
                                                             'hemi':'lh_LR164k_MSMSulc',
                                                             'load':_load_atlas_sphere},
                                                            {'registration':'fs_LR',
                                                             'hemi':'lh_LR164k_MSMAll',
                                                             'load':_load_atlas_sphere}),
        '{id}.L.flat.164k_fs_LR.surf.gii', ({'flatmap':'lh_LR164k_MSMSulc',
                                             'load':_load_atlas_sphere},
                                            {'flatmap':'lh_LR164k_MSMAll',
                                             'load':_load_atlas_sphere}),
        '{id}.R.ArealDistortion_FS.164k_fs_LR.shape.gii',      {'property':'areal_distortion_FS',
                                                                'hemi':'rh_LR164k_MSMSulc'},
        '{id}.R.ArealDistortion_MSMSulc.164k_fs_LR.shape.gii', {'property':'areal_distortion',
                                                                'hemi':'rh_LR164k_MSMSulc'},
        '{id}.R.MyelinMap.164k_fs_LR.func.gii',                {'property':'myelin',
                                                                'hemi':'rh_LR164k_MSMSulc'},
        '{id}.R.MyelinMap_BC.164k_fs_LR.func.gii',             {'property':'myelin_bc',
                                                                'hemi':'rh_LR164k_MSMSulc'},
        '{id}.R.SmoothedMyelinMap.164k_fs_LR.func.gii',        {'property':'myelin_smooth',
                                                                'hemi':'rh_LR164k_MSMSulc'},
        '{id}.R.SmoothedMyelinMap_BC.164k_fs_LR.func.gii',     {'property':'myelin_smooth_bc',
                                                                'hemi':'rh_LR164k_MSMSulc'},
        '{id}.R.RefMyelinMap.164k_fs_LR.func.gii',             {'property':'myelin_ref',
                                                                'hemi':'rh_LR164k_MSMSulc'},
        '{id}.R.BA.164k_fs_LR.label.gii',                      ({'property':'brodmann_area',
                                                                 'hemi':'rh_LR164k_MSMSulc'},
                                                                {'property':'brodmann_area',
                                                                 'hemi':'rh_LR164k_MSMAll'}),
        '{id}.R.aparc.164k_fs_LR.label.gii',         ({'property':'Desikan06_parcellation',
                                                       'hemi':'rh_LR164k_MSMSulc'},
                                                      {'property':'Desikan06_parcellation',
                                                       'hemi':'rh_LR164k_MSMAll'}),
        '{id}.R.aparc.a2009s.164k_fs_LR.label.gii',  ({'property':'parcellation',
                                                       'hemi':'rh_LR164k_MSMSulc'},
                                                      {'property':'parcellation',
                                                       'hemi':'rh_LR164k_MSMAll'},
                                                      {'property':'Destrieaux09_parcellation',
                                                      ...
                                                      {'property':'Destrieaux09_parcellation',
                                                       'hemi':'rh_LR164k_MSMAll'}),
        '{id}.R.atlasroi.164k_fs_LR.shape.gii',      ({'property':'atlas',
                                                       'hemi':'rh_LR164k_MSMSulc',
                                                       'load':_load_fsLR_atlasroi,
                                                       'filt':lambda x:x[1].astype(np.bool)},
                                                      {'property':'atlas',
                                                       ...
                                                       'load':_load_fsLR_atlasroi,
                                                       'filt':lambda x:x[1].astype(np.bool)}),
        '{id}.R.curvature.164k_fs_LR.shape.gii',     {'property':'curvature',
                                                      'hemi':'rh_LR164k_MSMSulc',
                                                      'filt':lambda c: -c},
        '{id}.R.sulc.164k_fs_LR.shape.gii',          {'property':'convexity',
                                                      'hemi':'rh_LR164k_MSMSulc'},
        '{id}.R.corrThickness.164k_fs_LR.shape.gii', {'property':'thickness',
                                                      'hemi':'rh_LR164k_MSMSulc'},
        '{id}.R.thickness.164k_fs_LR.shape.gii',     {'property':'thickness_uncorrected',
                                                      'hemi':'rh_LR164k_MSMSulc'},
        '{id}.R.sulc.164k_fs_LR.shape.gii',          {'surface':'convexity',
                                                      'hemi':'rh_LR164k_MSMSulc'},
        '{id}.R.white.164k_fs_LR.surf.gii',          {'surface':'white',
                                                      'hemi':'rh_LR164k_MSMSulc',
                                                      'load':_load_surfx},
        '{id}.R.midthickness.164k_fs_LR.surf.gii',   {'surface':'midgray',
                                                      'hemi':'rh_LR164k_MSMSulc',
                                                      'load':_load_surfx},
        '{id}.R.pial.164k_fs_LR.surf.gii',           {'surface':'pial',
                                                      'hemi':'rh_LR164k_MSMSulc',
                                                      'load':_load_surfx},
        '{id}.R.inflated.164k_fs_LR.surf.gii',       {'surface':'inflated',
                                                      'hemi':'rh_LR164k_MSMSulc',
                                                      'load':_load_surfx},
        '{id}.R.very_inflated.164k_fs_LR.surf.gii',  {'surface':'very_inflated',
                                                      'hemi':'rh_LR164k_MSMSulc',
                                                      'load':_load_surfx},
        '{id}.R.white_MSMAll.164k_fs_LR.surf.gii',   {'surface':'white',
                                                      'hemi':'rh_LR164k_MSMAll',
                                                      'load':_load_surfx},
        '{id}.R.midthickness_MSMAll.164k_fs_LR.surf.gii',  {'surface':'midgray',
                                                            'hemi':'rh_LR164k_MSMAll',
                                                            'load':_load_surfx},
        '{id}.R.pial_MSMAll.164k_fs_LR.surf.gii',          {'surface':'pial',
                                                            'hemi':'rh_LR164k_MSMAll',
                                                            'load':_load_surfx},
        '{id}.R.inflated_MSMAll.164k_fs_LR.surf.gii',      {'surface':'inflated',
                                                            'hemi':'rh_LR164k_MSMAll',
                                                            'load':_load_surfx},
        '{id}.R.very_inflated_MSMAll.164k_fs_LR.surf.gii', {'surface':'very_inflated',
                                                            'hemi':'rh_LR164k_MSMAll',
                                                            'load':_load_surfx},
        '{id}.R.sphere.164k_fs_LR.surf.gii', ({'registration':'fs_LR',
                                               'hemi':'rh_LR164k_MSMSulc',
                                               'load':_load_atlas_sphere},
                                              {'registration':'fs_LR',
                                               'hemi':'rh_LR164k_MSMAll',
                                               'load':_load_atlas_sphere}),
        '{id}.R.flat.164k_fs_LR.surf.gii', ({'flatmap':'rh_LR164k_MSMSulc',
                                             'load':_load_atlas_sphere},
                                            {'flatmap':'rh_LR164k_MSMAll',
                                             'load':_load_atlas_sphere}),
        '{id}.ArealDistortion_MSMAll.164k_fs_LR.dscalar.nii', {
            'property': 'areal_distortion',
            'hemi':     ('lh_LR164k_MSMAll', 'rh_LR164k_MSMAll')},
        '{id}.MyelinMap_BC_MSMAll.164k_fs_LR.dscalar.nii', {
            'property': 'myelin_bc',
            'hemi':     ('lh_LR164k_MSMAll', 'rh_LR164k_MSMAll')},
        '{id}.SmoothedMyelinMap_BC_MSMAll.164k_fs_LR.dscalar.nii', {
            'property': 'myelin_smooth_bc',
            'hemi':     ('lh_LR164k_MSMAll', 'rh_LR164k_MSMAll')},
        '{id}.curvature_MSMAll.164k_fs_LR.dscalar.nii', {
            'property': 'curvature',
            'hemi':     ('lh_LR164k_MSMAll', 'rh_LR164k_MSMAll'),
            'filt':     lambda c: -c},
        '{id}.sulc.164k_fs_LR.dscalar.nii', {
            'property': 'convexity',
            'hemi':     ('lh_LR164k_MSMAll', 'rh_LR164k_MSMAll')},
        '{id}.corrThickness.164k_fs_LR.dscalar.nii', {
            'property': 'thickness',
            'hemi':     ('lh_LR164k_MSMAll', 'rh_LR164k_MSMAll')},
        '{id}.thickness.164k_fs_LR.dscalar.nii', {
            'property': 'thickness_uncorrected',
            'hemi':     ('lh_LR164k_MSMAll', 'rh_LR164k_MSMAll')},
        'Native', [
            '{id}.L.ArealDistortion_FS.native.shape.gii', (
                {'property':'areal_distortion_FS', 'hemi':'lh_native_MSMSulc'},
                {'property':'areal_distortion_FS', 'hemi':'lh_native_MSMAll'}),
            '{id}.L.ArealDistortion_MSMSulc.native.shape.gii', {
                'property':'areal_distortion',
                'hemi':'lh_native_MSMSulc'},
            '{id}.L.ArealDistortion_MSMAll.native.shape.gii', {'property':'areal_distortion',
                                                               'hemi':'lh_native_MSMAll'},
            '{id}.L.MyelinMap.native.func.gii', {'property':'myelin',
                                                 'hemi':'lh_native_MSMSulc'},
            '{id}.L.MyelinMap_BC.native.func.gii', {'property':'myelin_bc',
                                                    'hemi':'lh_native_MSMSulc'},
            '{id}.L.SmoothedMyelinMap.native.func.gii', {'property':'myelin_smooth',
                                                         'hemi':'lh_native_MSMSulc'},
            '{id}.L.SmoothedMyelinMap_BC.native.func.gii', {'property':'myelin_smooth_bc',
                                                            'hemi':'lh_native_MSMSulc'},
            '{id}.L.RefMyelinMap.native.func.gii', {'property':'myelin_ref',
                                                    'hemi':'lh_native_MSMSulc'},
            '{id}.L.BA.native.label.gii', ({'property':'brodmann_area',
                                            'hemi':'lh_native_MSMSulc'},
                                           {'property':'brodmann_area',
                                            'hemi':'lh_native_MSMAll'}),
            '{id}.L.aparc.native.label.gii',  ({'property':'Deskian06_parcellation',
                                                'hemi':'lh_native_MSMSulc'},
                                               {'property':'Deskian06_parcellation',
                                                'hemi':'lh_native_MSMAll'}),
            '{id}.L.aparc.a2009s.native.label.gii', ({'property':'parcellation',
                                                      'hemi':'lh_native_MSMSulc'},
                                                     {'property':'parcellation',
                                                      'hemi':'lh_native_MSMAll'},
                                                     {'property':'Destrieaux09_parcellation',
                                                     ...
                                                     {'property':'Destrieaux09_parcellation',
                                                      'hemi':'lh_native_MSMAll'}),
            '{id}.L.atlasroi.native.shape.gii', ({'property':'atlas',
                                                  'hemi':'lh_native_MSMSulc',
                                                  'filt':lambda x:x.astype(np.bool)},
                                                 {'property':'atlas',
                                                  'hemi':'lh_native_MSMAll',
                                                  'filt':lambda x:x.astype(np.bool)}),
            '{id}.L.curvature.native.shape.gii', ({'property':'curvature',
                                                   'hemi':'lh_native_MSMSulc',
                                                   'filt':lambda c: -c},
                                                  {'property':'curvature',
                                                   'hemi':'lh_native_MSMAll',
                                                   'filt':lambda c: -c}),
            '{id}.L.sulc.native.shape.gii', ({'property':'convexity',
                                              'hemi':'lh_native_MSMSulc'},
                                             {'property':'convexity',
                                              'hemi':'lh_native_MSMAll'}),
            '{id}.L.corrThickness.native.shape.gii', ({'property':'thickness',
                                                       'hemi':'lh_native_MSMSulc'},
                                                      {'property':'thickness',
                                                       'hemi':'lh_native_MSMAll'}),
            '{id}.L.thickness.native.shape.gii', ({'property':'thickness_uncorrected',
                                                   'hemi':'lh_native_MSMSulc'},
                                                  {'property':'thickness_uncorrected',
                                                   'hemi':'lh_native_MSMAll'}),
            '{id}.L.roi.native.shape.gii', ({'property':'roi',
                                             'hemi':'lh_native_MSMSulc',
                                             'filt':lambda r: r.astype(bool)},
                                            {'property':'roi',
                                             'hemi':'lh_native_MSMAll',
                                             'filt':lambda r: r.astype(bool)}),
            '{id}.L.sphere.native.surf.gii', ({'registration':'native',
                                               'hemi':'lh_native_MSMSulc',
                                               'load':_load_surfx},
                                              {'registration':'native',
                                               'hemi':'lh_native_MSMAll',
                                               'load':_load_surfx}),
            '{id}.L.sphere.reg.native.surf.gii', ({'registration':'fsaverage',
                                                   'hemi':'lh_native_MSMSulc',
                                                   'load':_load_surfx},
                                                  {'registration':'fsaverage',
                                                   'hemi':'lh_native_MSMAll',
                                                   'load':_load_surfx}),
            '{id}.L.sphere.MSMAll.native.surf.gii', {'registration':'fs_LR',
                                                     'tool':'MSMAll',
                                                     'hemi':'lh_native_MSMAll',
                                                     'load':_load_surfx},
            '{id}.L.sphere.MSMSulc.native.surf.gii', {'registration':'fs_LR',
                                                      'tool':'MSMSulc',
                                                      'hemi':'lh_native_MSMSulc',
                                                      'load':_load_surfx},
            '{id}.R.ArealDistortion_FS.native.shape.gii', ({'property':'areal_distortion_FS',
                                                            'hemi':'rh_native_MSMSulc'},
                                                           {'property':'areal_distortion_FS',
                                                            'hemi':'rh_native_MSMAll'}),
            '{id}.R.ArealDistortion_MSMSulc.native.shape.gii', {'property':'areal_distortion',
                                                                'hemi':'rh_native_MSMSulc'},
            '{id}.R.ArealDistortion_MSMAll.native.shape.gii', {'property':'areal_distortion',
                                                               'hemi':'rh_native_MSMAll'},
            '{id}.R.MyelinMap.native.func.gii', {'property':'myelin',
                                                 'hemi':'rh_native_MSMSulc'},
            '{id}.R.MyelinMap_BC.native.func.gii', {'property':'myelin_bc',
                                                    'hemi':'rh_native_MSMSulc'},
            '{id}.R.SmoothedMyelinMap.native.func.gii', {'property':'myelin_smooth',
                                                         'hemi':'rh_native_MSMSulc'},
            '{id}.R.SmoothedMyelinMap_BC.native.func.gii', {'property':'myelin_smooth_bc',
                                                            'hemi':'rh_native_MSMSulc'},
            '{id}.R.RefMyelinMap.native.func.gii', {'property':'myelin_ref',
                                                    'hemi':'rh_native_MSMSulc'},
            '{id}.R.BA.native.label.gii', ({'property':'brodmann_area',
                                            'hemi':'rh_native_MSMSulc'},
                                           {'property':'brodmann_area',
                                            'hemi':'rh_native_MSMAll'}),
            '{id}.R.aparc.native.label.gii',  ({'property':'Desikan06_parcellation',
                                                'hemi':'rh_native_MSMSulc'},
                                               {'property':'Desikan06_parcellation',
                                                'hemi':'rh_native_MSMAll'}),
            '{id}.R.aparc.a2009s.native.label.gii', ({'property':'parcellation',
                                                      'hemi':'rh_native_MSMSulc'},
                                                     {'property':'parcellation',
                                                      'hemi':'rh_native_MSMAll'},
                                                     {'property':'Destrieaux09_parcellation',
                                                     ...
                                                     {'property':'Destrieaux09_parcellation',
                                                      'hemi':'rh_native_MSMAll'}),
            '{id}.R.atlasroi.native.shape.gii', ({'property':'atlas',
                                                  'hemi':'rh_native_MSMSulc',
                                                  'filt':lambda x:x.astype(np.bool)},
                                                 {'property':'atlas',
                                                  'hemi':'rh_native_MSMAll',
                                                  'filt':lambda x:x.astype(np.bool)}),
            '{id}.R.curvature.native.shape.gii', ({'property':'curvature',
                                                   'hemi':'rh_native_MSMSulc',
                                                   'filt':lambda c: -c},
                                                  {'property':'curvature',
                                                   'hemi':'rh_native_MSMAll',
                                                   'filt':lambda c: -c}),
            '{id}.R.sulc.native.shape.gii', ({'property':'convexity',
                                              'hemi':'rh_native_MSMSulc'},
                                             {'property':'convexity',
                                              'hemi':'rh_native_MSMAll'}),
            '{id}.R.corrThickness.native.shape.gii', ({'property':'thickness',
                                                       'hemi':'rh_native_MSMSulc'},
                                                      {'property':'thickness',
                                                       'hemi':'rh_native_MSMAll'}),
            '{id}.R.thickness.native.shape.gii', ({'property':'thickness_uncorrected',
                                                   'hemi':'rh_native_MSMSulc'},
                                                  {'property':'thickness_uncorrected',
                                                   'hemi':'rh_native_MSMAll'}),
            '{id}.R.roi.native.shape.gii', ({'property':'roi',
                                             'hemi':'rh_native_MSMSulc',
                                             'filt':lambda r: r.astype(bool)},
                                            {'property':'roi',
                                             'hemi':'rh_native_MSMAll',
                                             'filt':lambda r: r.astype(bool)}),
            '{id}.R.sphere.native.surf.gii', ({'registration':'native',
                                               'hemi':'rh_native_MSMSulc',
                                               'load':_load_surfx},
                                              {'registration':'native',
                                               'hemi':'rh_native_MSMAll',
                                               'load':_load_surfx}),
            '{id}.R.sphere.reg.native.surf.gii', ({'registration':'fsaverage',
                                                   'hemi':'rh_native_MSMSulc',
                                                   'load':_load_surfx},
                                                  {'registration':'fsaverage',
                                                   'hemi':'rh_native_MSMAll',
                                                   'load':_load_surfx}),
            '{id}.R.sphere.MSMAll.native.surf.gii', {'registration':'fs_LR',
                                                     'tool':'MSMAll',
                                                     'hemi':'rh_native_MSMAll',
                                                     'load':_load_surfx},
            '{id}.R.sphere.MSMSulc.native.surf.gii', {'registration':'fs_LR',
                                                      'tool':'MSMSulc',
                                                      'hemi':'rh_native_MSMSulc',
                                                      'load':_load_surfx}],
        'fsaverage_LR59k', [
            '{id}.L.BA.59k_fs_LR.label.gii', ({'property':'brodmann_area',
                                               'hemi':'lh_LR59k_MSMSulc'},
                                              {'property':'brodmann_area',
                                               'hemi':'lh_LR59k_MSMAll'}),
            '{id}.L.aparc.59k_fs_LR.label.gii', ({'property':'Desikan06_parcellation',
                                                  'hemi':'lh_LR59k_MSMSulc'},
                                                 {'property':'Desikan06_parcellation',
                                                  'hemi':'lh_LR59k_MSMAll'}),
            '{id}.L.aparc.a2009s.59k_fs_LR.label.gii', ({'property':'parcellation',
                                                         'hemi':'lh_LR59k_MSMSulc'},
                                                        {'property':'parcellation',
                                                         'hemi':'lh_LR59k_MSMAll'},
                                                        {'property':'Destrieaux09_parcellation',
                                                        ...
                                                        {'property':'Destrieaux09_parcellation',
                                                         'hemi':'lh_LR59k_MSMAll'}),
            '{id}.L.atlasroi.59k_fs_LR.shape.gii', ({'property':'atlas',
                                                     'hemi':'lh_LR59k_MSMSulc',
                                                     'load':_load_fsLR_atlasroi,
                                                     'filt':lambda x:x[0].astype(np.bool)},
                                                    {'property':'atlas',
                                                     ...
                                                     'load':_load_fsLR_atlasroi,
                                                     'filt':lambda x:x[0].astype(np.bool)}),
            '{id}.L.ArealDistortion_FS.59k_fs_LR.shape.gii', ({'property':'areal_distortion_fs',
                                                               'hemi':'lh_LR59k_MSMSulc'},
                                                              {'property':'areal_distortion_fs',
                                                               'hemi':'lh_LR59k_MSMAll'}),
            '{id}.L.ArealDistortion_MSMSulc.59k_fs_LR.shape.gii', {'property':'areal_distortion',
                                                                   'hemi':'lh_LR59k_MSMSulc'},
            '{id}.L.MyelinMap.59k_fs_LR.func.gii', {'property':'myelin',
                                                    'hemi':'lh_LR59k_MSMSulc'},
            #'{id}.L.MyelinMap_BC.59k_fs_LR.func.gii', {
            #    'property':'myelin_bc',
            #    'hemi':'lh_LR59k_MSMSulc'},
            '{id}.L.SmoothedMyelinMap.59k_fs_LR.func.gii', {'property':'myelin_smooth',
                                                            'hemi':'lh_LR59k_MSMSulc'},
            #'{id}.L.SmoothedMyelinMap_BC.59k_fs_LR.func.gii', {
            #    'property':'myelin_smooth_bc',
            #    'hemi':'lh_LR59k_MSMSulc'},
            '{id}.L.curvature.59k_fs_LR.shape.gii', {'property':'curvature',
                                                     'hemi':'lh_LR59k_MSMSulc',
                                                     'filt':lambda c: -c},
            '{id}.L.sulc.59k_fs_LR.shape.gii', {'property':'convexity',
                                                'hemi':'lh_LR59k_MSMSulc'},
            #'{id}.L.corrThickness.59k_fs_LR.shape.gii', {
            #    'property':'thickness',
            #    'hemi':'lh_LR59k_MSMSulc'},
            '{id}.L.thickness.59k_fs_LR.shape.gii', {'property':'thickness_uncorrected',
                                                     'hemi':'lh_LR59k_MSMSulc'},
            '{id}.L.white.59k_fs_LR.surf.gii', {'surface':'white',
                                                'hemi':'lh_LR59k_MSMSulc',
                                                'load':_load_surfx},
            ...
            '{id}.L.very_inflated_1.6mm_MSMAll.59k_fs_LR.surf.gii', {'surface':'very_inflated',
                                                                     'hemi':'lh_LR59k_MSMAll',
                                                                     'load':_load_surfx},
            '{id}.L.flat.59k_fs_LR.surf.gii', ({'flatmap':'lh_LR59k_MSMSulc'},
                                               {'flatmap':'lh_LR59k_MSMAll'}),
            '{id}.L.sphere.59k_fs_LR.surf.gii', ({'registration':'fs_LR',
                                                  'hemi':'lh_LR59k_MSMSulc',
                                                  'load':_load_surfx},
                                                 {'registration':'fs_LR',
                                                  'hemi':'lh_LR59k_MSMAll',
                                                  'load':_load_surfx}),
            '{id}.R.BA.59k_fs_LR.label.gii', ({'property':'brodmann_area',
                                               'hemi':'rh_LR59k_MSMSulc'},
                                              {'property':'brodmann_area',
                                               'hemi':'rh_LR59k_MSMAll'}),
            '{id}.R.aparc.59k_fs_LR.label.gii', ({'property':'Deskian06_parcellation',
                                                  'hemi':'rh_LR59k_MSMSulc'},
                                                 {'property':'Desikan06_parcellation',
                                                  'hemi':'rh_LR59k_MSMAll'}),
            '{id}.R.aparc.a2009s.59k_fs_LR.label.gii', ({'property':'parcellation',
                                                         'hemi':'rh_LR59k_MSMSulc'},
                                                        {'property':'parcellation',
                                                         'hemi':'rh_LR59k_MSMAll'},
                                                        {'property':'Destrieaux09_parcellation',
                                                        ...
                                                        {'property':'Destrieaux09_parcellation',
                                                         'hemi':'rh_LR59k_MSMAll'}),
            '{id}.R.atlasroi.59k_fs_LR.shape.gii', ({'property':'atlas',
                                                     'hemi':'rh_LR59k_MSMSulc',
                                                     'load':_load_fsLR_atlasroi,
                                                     'filt':lambda x:x[1].astype(np.bool)},
                                                    {'property':'atlas',
                                                     ...
                                                     'load':_load_fsLR_atlasroi,
                                                     'filt':lambda x:x[1].astype(np.bool)}),
            '{id}.R.ArealDistortion_FS.59k_fs_LR.shape.gii', ({'property':'areal_distortion_fs',
                                                               'hemi':'rh_LR59k_MSMSulc'},
                                                              {'property':'areal_distortion_fs',
                                                               'hemi':'rh_LR59k_MSMAll'}),
            '{id}.R.ArealDistortion_MSMSulc.59k_fs_LR.shape.gii', {'property':'areal_distortion',
                                                                   'hemi':'rh_LR59k_MSMSulc'},
            '{id}.R.MyelinMap.59k_fs_LR.func.gii', {'property':'myelin',
                                                    'hemi':'rh_LR59k_MSMSulc'},
            #'{id}.R.MyelinMap_BC.59k_fs_LR.func.gii', {
            #    'property':'myelin_bc',
            #    'hemi':'rh_LR59k_MSMSulc'},
            '{id}.R.SmoothedMyelinMap.59k_fs_LR.func.gii', {'property':'myelin_smooth',
                                                            'hemi':'rh_LR59k_MSMSulc'},
            #'{id}.R.SmoothedMyelinMap_BC.59k_fs_LR.func.gii', {
            #    'property':'myelin_smooth_bc',
            #    'hemi':'rh_LR59k_MSMSulc'},
            '{id}.R.curvature.59k_fs_LR.shape.gii', {'property':'curvature',
                                                     'hemi':'rh_LR59k_MSMSulc',
                                                     'filt':lambda c: -c},
            '{id}.R.sulc.59k_fs_LR.shape.gii', {'property':'convexity',
                                                'hemi':'rh_LR59k_MSMSulc'},
            #'{id}.R.corrThickness.59k_fs_LR.shape.gii', {
            #    'property':'thickness',
            #    'hemi':'rh_LR59k_MSMSulc'},
            '{id}.R.thickness.59k_fs_LR.shape.gii', {'property':'thickness_uncorrected',
                                                     'hemi':'rh_LR59k_MSMSulc'},
            '{id}.R.white.59k_fs_LR.surf.gii', {'surface':'white',
                                                'hemi':'rh_LR59k_MSMSulc',
                                                'load':_load_surfx},
            ...
            '{id}.R.very_inflated_1.6mm_MSMAll.59k_fs_LR.surf.gii', {'surface':'very_inflated',
                                                                     'hemi':'rh_LR59k_MSMAll',
                                                                     'load':_load_surfx},
            '{id}.R.flat.59k_fs_LR.surf.gii', ({'flatmap':'rh_LR59k_MSMSulc',
                                                'load':_load_atlas_sphere},
                                               {'flatmap':'rh_LR59k_MSMAll',
                                                'load':_load_atlas_sphere}),
            '{id}.R.sphere.59k_fs_LR.surf.gii', ({'registration':'fs_LR',
                                                  'hemi':'rh_LR59k_MSMSulc',
                                                  'load':_load_atlas_sphere},
                                                 {'registration':'fs_LR',
                                                  'hemi':'rh_LR59k_MSMAll',
                                                  'load':_load_atlas_sphere}),
            '{id}.ArealDistortion_1.6mm_MSMAll.59k_fs_LR.dscalar.nii', {
                'property':'areal_distortion',
                'hemi':('lh_LR59k_MSMAll', 'rh_LR59k_MSMAll')},
            '{id}.MyelinMap_BC_1.6mm_MSMAll.59k_fs_LR.dscalar.nii', {
                'property':'myelin_bc',
                'hemi':('lh_LR59k_MSMAll', 'rh_LR59k_MSMAll')},
            '{id}.SmoothedMyelinMap_BC_1.6mm_MSMAll.59k_fs_LR.dscalar.nii', {
                'property':'myelin_smooth_bc',
                'hemi':('lh_LR59k_MSMAll', 'rh_LR59k_MSMAll')},
            '{id}.curvature_1.6mm_MSMAll.59k_fs_LR.dscalar.nii', {
                'property':'curvature',
                'hemi':('lh_LR59k_MSMAll', 'rh_LR59k_MSMAll'),
                'filt':lambda c: -c},
            '{id}.sulc_1.6mm_MSMAll.59k_fs_LR.dscalar.nii', {
                'property':'convexity',
                'hemi':('lh_LR59k_MSMAll', 'rh_LR59k_MSMAll')},
            '{id}.corrThickness_1.6mm_MSMAll.59k_fs_LR.dscalar.nii', {
                'property':'thickness',
                'hemi':('lh_LR59k_MSMAll', 'rh_LR59k_MSMAll')},
            '{id}.thickness_1.6mm_MSMAll.59k_fs_LR.dscalar.nii', {
                'property':'thickness_uncorrected',
                'hemi':('lh_LR59k_MSMAll', 'rh_LR59k_MSMAll')}],
        'fsaverage_LR32k', [
            '{id}.L.BA.32k_fs_LR.label.gii', ({'property':'brodmann_area',
                                               'hemi':'lh_LR32k_MSMSulc'},
                                              {'property':'brodmann_area',
                                               'hemi':'lh_LR32k_MSMAll'}),
            '{id}.L.aparc.32k_fs_LR.label.gii', ({'property':'Desikan06_parcellation',
                                                  'hemi':'lh_LR32k_MSMSulc'},
                                                 {'property':'Desikan06_parcellation',
                                                  'hemi':'lh_LR32k_MSMAll'}),
            '{id}.L.aparc.a2009s.32k_fs_LR.label.gii', ({'property':'parcellation',
                                                         'hemi':'lh_LR32k_MSMSulc'},
                                                        {'property':'parcellation',
                                                         'hemi':'lh_LR32k_MSMAll'},
                                                        {'property':'Destrieaux09_parcellation',
                                                        ...
                                                        {'property':'Destrieaux09_parcellation',
                                                         'hemi':'lh_LR32k_MSMAll'}),
            '{id}.L.atlasroi.32k_fs_LR.shape.gii', ({'property':'atlas',
                                                     'hemi':'lh_LR32k_MSMSulc',
                                                     'load':_load_fsLR_atlasroi,
                                                     'filt':lambda x:x[0].astype(np.bool)},
                                                    {'property':'atlas',
                                                     ...
                                                     'load':_load_fsLR_atlasroi,
                                                     'filt':lambda x:x[0].astype(np.bool)}),
            '{id}.L.ArealDistortion_FS.32k_fs_LR.shape.gii', ({'property':'areal_distortion_fs',
                                                               'hemi':'lh_LR32k_MSMSulc'},
                                                              {'property':'areal_distortion_fs',
                                                               'hemi':'lh_LR32k_MSMAll'}),
            '{id}.L.ArealDistortion_MSMSulc.32k_fs_LR.shape.gii', {'property':'areal_distortion',
                                                                   'hemi':'lh_LR32k_MSMSulc'},
            '{id}.L.MyelinMap.32k_fs_LR.func.gii', {'property':'myelin',
                                                    'hemi':'lh_LR32k_MSMSulc'},
            '{id}.L.MyelinMap_BC.32k_fs_LR.func.gii', {'property':'myelin_bc',
                                                       'hemi':'lh_LR32k_MSMSulc'},
            '{id}.L.SmoothedMyelinMap.32k_fs_LR.func.gii', {'property':'myelin_smooth',
                                                            'hemi':'lh_LR32k_MSMSulc'},
            '{id}.L.SmoothedMyelinMap_BC.32k_fs_LR.func.gii', {'property':'myelin_smooth_bc',
                                                               'hemi':'lh_LR32k_MSMSulc'},
            '{id}.L.curvature.32k_fs_LR.shape.gii', {'property':'curvature',
                                                     'hemi':'lh_LR32k_MSMSulc',
                                                     'filt':lambda c: -c},
            '{id}.L.sulc.32k_fs_LR.shape.gii', {'property':'convexity',
                                                'hemi':'lh_LR32k_MSMSulc'},
            '{id}.L.corrThickness.32k_fs_LR.shape.gii', {'property':'thickness',
                                                         'hemi':'lh_LR32k_MSMSulc'},
            '{id}.L.thickness.32k_fs_LR.shape.gii', {'property':'thickness_uncorrected',
                                                     'hemi':'lh_LR32k_MSMSulc'},
            '{id}.L.white.32k_fs_LR.surf.gii', {'surface':'white',
                                                'hemi':'lh_LR32k_MSMSulc',
                                                'load':_load_surfx},
            ...
            '{id}.L.very_inflated_MSMAll.32k_fs_LR.surf.gii', {'surface':'very_inflated',
                                                               'hemi':'lh_LR32k_MSMAll',
                                                               'load':_load_surfx},
            '{id}.L.flat.32k_fs_LR.surf.gii', ({'flatmap':'lh_LR32k_MSMSulc'},
                                               {'flatmap':'lh_LR32k_MSMAll'}),
            '{id}.L.sphere.32k_fs_LR.surf.gii', ({'registration':'fs_LR',
                                                  'hemi':'lh_LR32k_MSMSulc',
                                                  'load':_load_surfx},
                                                 {'registration':'fs_LR',
                                                  'hemi':'lh_LR32k_MSMAll',
                                                  'load':_load_surfx}),
            '{id}.R.BA.32k_fs_LR.label.gii', ({'property':'brodmann_area',
                                               'hemi':'rh_LR32k_MSMSulc'},
                                              {'property':'brodmann_area',
                                               'hemi':'rh_LR32k_MSMAll'}),
            '{id}.R.aparc.32k_fs_LR.label.gii', ({'property':'Desikan06_parcellation',
                                                  'hemi':'rh_LR32k_MSMSulc'},
                                                 {'property':'Desikan06_parcellation',
                                                  'hemi':'rh_LR32k_MSMAll'}),
            '{id}.R.aparc.a2009s.32k_fs_LR.label.gii', ({'property':'parcellation',
                                                         'hemi':'rh_LR32k_MSMSulc'},
                                                        {'property':'parcellation',
                                                         'hemi':'rh_LR32k_MSMAll'},
                                                        {'property':'Destrieaux09_parcellation',
                                                        ...
                                                        {'property':'Destrieaux09_parcellation',
                                                         'hemi':'rh_LR32k_MSMAll'}),
            '{id}.R.atlasroi.32k_fs_LR.shape.gii', ({'property':'atlas',
                                                     'hemi':'rh_LR32k_MSMSulc',
                                                     'load':_load_fsLR_atlasroi,
                                                     'filt':lambda x:x[1].astype(np.bool)},
                                                    {'property':'atlas',
                                                     ...
                                                     'load':_load_fsLR_atlasroi,
                                                     'filt':lambda x:x[1].astype(np.bool)}),
            '{id}.R.ArealDistortion_FS.32k_fs_LR.shape.gii', ({'property':'areal_distortion_fs',
                                                               'hemi':'rh_LR32k_MSMSulc'},
                                                              {'property':'areal_distortion_fs',
                                                               'hemi':'rh_LR32k_MSMAll'}),
            '{id}.R.ArealDistortion_MSMSulc.32k_fs_LR.shape.gii', {'property':'areal_distortion',
                                                                   'hemi':'rh_LR32k_MSMSulc'},
            '{id}.R.MyelinMap.32k_fs_LR.func.gii', {'property':'myelin',
                                                    'hemi':'rh_LR32k_MSMSulc'},
            '{id}.R.MyelinMap_BC.32k_fs_LR.func.gii', {'property':'myelin_bc',
                                                       'hemi':'rh_LR32k_MSMSulc'},
            '{id}.R.SmoothedMyelinMap.32k_fs_LR.func.gii', {'property':'myelin_smooth',
                                                            'hemi':'rh_LR32k_MSMSulc'},
            '{id}.R.SmoothedMyelinMap_BC.32k_fs_LR.func.gii', {'property':'myelin_smooth_bc',
                                                               'hemi':'rh_LR32k_MSMSulc'},
            '{id}.R.curvature.32k_fs_LR.shape.gii', {'property':'curvature',
                                                     'hemi':'rh_LR32k_MSMSulc',
                                                     'filt':lambda c: -c},
            '{id}.R.sulc.32k_fs_LR.shape.gii', {'property':'convexity',
                                                'hemi':'rh_LR32k_MSMSulc'},
            '{id}.R.corrThickness.32k_fs_LR.shape.gii', {'property':'thickness',
                                                         'hemi':'rh_LR32k_MSMSulc'},
            '{id}.R.thickness.32k_fs_LR.shape.gii', {'property':'thickness_uncorrected',
                                                     'hemi':'rh_LR32k_MSMSulc'},
            '{id}.R.white.32k_fs_LR.surf.gii', {'surface':'white',
                                                'hemi':'rh_LR32k_MSMSulc',
                                                'load':_load_surfx},
            ...
            '{id}.R.very_inflated_MSMAll.32k_fs_LR.surf.gii', {'surface':'very_inflated',
                                                               'hemi':'rh_LR32k_MSMAll',
                                                               'load':_load_surfx},
            '{id}.R.flat.32k_fs_LR.surf.gii', ({'flatmap':'rh_LR32k_MSMSulc',
                                                'load':_load_atlas_sphere},
                                               {'flatmap':'rh_LR32k_MSMAll',
                                                'load':_load_atlas_sphere}),
            '{id}.R.sphere.32k_fs_LR.surf.gii', ({'registration':'fs_LR',
                                                  'hemi':'rh_LR32k_MSMSulc',
                                                  'load':_load_atlas_sphere},
                                                 {'registration':'fs_LR',
                                                  'hemi':'rh_LR32k_MSMAll',
                                                  'load':_load_atlas_sphere}),
            '{id}.ArealDistortion_MSMAll.32k_fs_LR.dscalar.nii', {
                'property':'areal_distortion',
                'hemi':('lh_LR32k_MSMAll', 'rh_LR32k_MSMAll')},
            '{id}.MyelinMap_BC_MSMAll.32k_fs_LR.dscalar.nii', {
                'property':'myelin_bc',
                'hemi':('lh_LR32k_MSMAll', 'rh_LR32k_MSMAll')},
            '{id}.SmoothedMyelinMap_BC_MSMAll.32k_fs_LR.dscalar.nii', {
                'property':'myelin_smooth_bc',
                'hemi':('lh_LR32k_MSMAll', 'rh_LR32k_MSMAll')},
            '{id}.curvature_MSMAll.32k_fs_LR.dscalar.nii', {
                'property':'curvature',
                'hemi':('lh_LR32k_MSMAll', 'rh_LR32k_MSMAll'),
                'filt':lambda c: -c},
            '{id}.sulc_MSMAll.32k_fs_LR.dscalar.nii', {
                'property':'convexity',
                'hemi':('lh_LR32k_MSMAll', 'rh_LR32k_MSMAll')},
            '{id}.corrThickness_MSMAll.32k_fs_LR.dscalar.nii', {
                'property':'thickness',
                'hemi':('lh_LR32k_MSMAll', 'rh_LR32k_MSMAll')},
            '{id}.thickness_MSMAll.32k_fs_LR.dscalar.nii', {
                'property':'thickness_uncorrected',
                'hemi':('lh_LR32k_MSMAll', 'rh_LR32k_MSMAll')}]]]
